...
> **About this file**
>
> This is the original English README from the upstream project
> [Vinzent03/obsidian-git](https://github.com/Vinzent03/obsidian-git).
> It is kept verbatim in this fork purely for reference and easy comparison
> with the Chinese translation in [`README.md`](./README.md).
> All credits, license and maintenance belong to the original author
> [Vinzent03](https://github.com/Vinzent03).
...
> - run indefinitely.
>
> It's caused by the underlying git implementation on mobile, which is not efficient. I don't know how to fix this. If that's the case for you, I have to admit this plugin won't work for you. So commenting on any issue or creating a new issue won't help. I am sorry.
